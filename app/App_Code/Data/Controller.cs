...
namespace RiverlandIndustries.Data
{
    public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                    res = ControllerConfigurationUtility.GetResourceStream(string.Format("RiverlandIndustries.controllers.{0}.xml", controller), string.Format("RiverlandIndustries.{0}.xml", controller));
                if (res == null)
                {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
                t = typeof(RiverlandIndustries.Data.Controller);
            var res = ControllerConfigurationUtility.GetResourceStream(string.Format("RiverlandIndustries.Reports.{0}", name), string.Format("RiverlandIndustries.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                var config = RiverlandIndustries.Data.Controller.CreateConfigurationInstance(t, controller);
