...
namespace RiverlandIndustries.Data
{
    public class ControllerConfiguration
    {
        ...
        protected virtual void Initialize(XPathNavigator navigator)
        {
            ...
            {
                var t = ApplicationServices.StringToType("RiverlandIndustries.Rules.SharedBusinessRules");
                if (t != null)
        ...
        public virtual void Complete()
        {
            ...
            if (string.IsNullOrEmpty(_connectionStringName))
                _connectionStringName = "RiverlandIndustries";
...
<action id=""a5"" commandName=""Edit"" causesValidation=""true"" />
        ...
        public string LoadLayout(string view)
        {
            ...
            while (tryLoad)
            {
                ...
                {
                    var stream = GetType().Assembly.GetManifestResourceStream(string.Format("RiverlandIndustries.Views.{0}.{1}.html", this.ControllerName, view));
                    if (stream != null)
                    {
    ...
    public class ControllerConfigurationUtility
    {
        ...
        public static string[] GetDataControllerList()
        {
            ...
            {
                var m = Regex.Match(r.Value, "^RiverlandIndustries\\.(controllers\\.)?(.+?)\\.xml$", RegexOptions.IgnoreCase);
                if (m.Success)
                {
