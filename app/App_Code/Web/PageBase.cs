...
namespace RiverlandIndustries.Web
{
    ...
    public class PageBaseCore : System.Web.UI.Page
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            var page = RiverlandIndustries.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString());
    ...
    public class ControlBaseCore : System.Web.UI.UserControl
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            writer.Write(RiverlandIndustries.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString()));
        }
        ...
        public static System.Web.UI.Control LoadPageControl(System.Web.UI.Control placeholder, string pageName, bool developmentMode)
        {
            try
            {
                ...
                var basePath = "~";
                if (!developmentMode)
                    basePath = "~/DesktopModules/RiverlandIndustries";
