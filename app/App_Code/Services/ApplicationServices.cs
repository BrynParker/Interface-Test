...
using RiverlandIndustries.Data;
...
namespace RiverlandIndustries.Services
{
        ...
        public static string ValidationKey
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(key) || key.Contains("AutoGenerate"))
                    key = "B06FF9EA004D0A4DBDFA13E7C14867670658C155AA30D8875F6483F97B63CCE531496C3BB454A6D0354E3471051C5D83FA292A8E57C4668D5EDD6A9F487402C6";
                return key;
            }
        }
    ...
    public partial class ApplicationServicesBase
    {
                ...
                if (_defaultSettings == null)
                {
                    ...
                    if (_defaultSettings == null)
                    {
                        ...
                        if (_defaultSettings == null)
                        {
                            ...
                            EnsureJsonProperty(ui, "theme.accent", "Cay");
        ...
        {
            RiverlandIndustries.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            if (AuthorizationIsSupported)
            {
                ...
                if (Membership.GetUser("admin") == null)
                {
                    ...
                    admin = Membership.CreateUser("admin", "admin123%", "admin@RiverlandIndustries.com", "ASP.NET", "Code OnTime", true, out status);
                    user = Membership.CreateUser("user", "user123%", "user@RiverlandIndustries.com", "ASP.NET", "Code OnTime", true, out status);
                    offline = Membership.CreateUser("offline", "offline123%", "offline@RiverlandIndustries.com", "ASP.NET", "Code OnTime", true, out status);
